...
|        Last Modified: 2024/05/09 10:38:55
|
|        $Author: Tgtje $
+---------------------------------------------------------------+
*/
...
define("FMLAN_52", "Você pode gerenciar os arquivos em seu diretório /files nesta página. Se você estiver recebendo uma mensagem de erro sobre permissões durante o carregamento, faça CHMOD no diretório para o qual você está tentando fazer carregamento para 777.");
define("FMLAN_53", "Ajuda do Gerenciador de Arquivos");
