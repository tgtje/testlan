...
define("CUSLAN_83", "Será listado no Menu-Manager com este nome ou pode ser chamado usando {CMENU=name} no seu tema. Deve usar apenas caracteres ASCII e estar todos em letras minúsculas.");
define("CUSLAN_84", "Legenda exibida no item de menu.");
define("CUSLAN_85", "Deixe em branco para usar o padrão");
define("CUSLAN_86", "Deixe em branco para usar a página correspondente");
define("CUSLAN_87", "A partir desta área você pode criar menus e páginas personalizadas com seu próprio conteúdo.<br />Menus e páginas são vinculados para que você possa ter um menu facilmente vinculado de volta à página, se desejar.");
define("CUSLAN_88", "Ajuda de menus/páginas personalizadas");
