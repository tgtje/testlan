...
//admin/help/
define("USRLAN_258", "This page shows a list of your registered members. You can update their settings, give them administrator status and set their user class 
	among other things.<br /><br />	The sort order can be changed by clicking on the column heading.<br /><br />
	<b>Userclasses</b><br />
	...
	<b>Activate</b><br />	This activates a user who would normally have replied to the activation email.<br /><br />
	<b>Resend Email</b><br />	Resends the activation email to the user.<br /><br />
	<b>Test email</b><br />	Check user's email address for validity (doesn't send an email)<br /><br />
	<b>Delete</b><br />	Totally removes the user from membership of the site (any forum posts, comments etc remain, and are flagged as from a 'Deleted User')");//text
define("USRLAN_259", "User Management");//caption
