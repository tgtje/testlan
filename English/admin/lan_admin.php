...
//admin/help/
define("ADLAN_196", "Use this page to edit the preferences for, or delete site administrators. The administrator will only have permission to access the features that are ticked.<br /><br />
To create a new admin go to the user config page and update an existing user to admin status.");//text
define("ADLAN_197", "Site Admin Help");//caption
