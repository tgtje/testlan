...
//admin/help/
define("LCLAN_117", "Enter all your site links here. Links added here will be shown in your main navigation menu, for other links please use the Links Page plugin.
<br />");//text
define("LCLAN_118", "Links Help");//caption
