...
//admin/help/
define("UPLLAN_71", "This page lists any submitted uploads. You may choose to delete them, transfer them to downloads, or post them to news");//text
define("UPLLAN_72", "Public Uploads Help");//caption
