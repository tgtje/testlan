...
//admin/help/
define("EMOLAN_39", "With emoticons activated, standard smiley text strings will be replaced by their 
respective emoticon images throughout the content in your site.");//text
define("EMOLAN_40", "Emoticon Help");//caption
