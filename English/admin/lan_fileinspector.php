...
//admin/help/
define("FR_LAN_34", "File Inspector scans and analyses the files on your sites server. When File Inspector encounters 
an e107 core file, it checks it for file consistency to make sure it isn't corrupted.");//text1
define("FR_LAN_35", "<br /><br />
<a href='".e_SELF."?create'>Click here to create a snapshot of your own plugins files for use in File Inspector.</a>");//text2
define("FR_LAN_36", "<br /><br />
The additional string matching tool (developer mode only) enables you to scan the files on your server for text strings 
using regular expressions. The regex engine in use is PHP's <a href='https://php.net/pcre'>PCRE</a> 
(the preg_* functions), so enter your query as #pattern#modifiers in the fields provided.");//text3
define("FR_LAN_37", "File Inspector Help");//caption
