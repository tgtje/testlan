...
//admin/help/
define("EXTLAN_88", "Extended user fields allow you to add additional types of data a user is able to specify as part of their profile.");//text 
define("EXTLAN_89", "Extended User Fields Help");//caption
