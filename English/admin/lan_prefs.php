...
//admin/help/
define("PRFLAN_288", "Your preferences allow you to specify all the important settings on your site, from site name and description to flood protection and profanity filtering.");//text
define("PRFLAN_289", "Preferences Help");//caption